...
import net.dynamicandroid.mftm.util.UIUtils;
...
public abstract class AsyncTask<Params, Progress, Result> {
    private static final String LOG_TAG = "PartyAsyncTask";
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "PartyAsyncTask #" + mCount.getAndIncrement());
        }
    };
    ...
    public final AsyncTask<Params, Progress, Result> executeOnThreadPoolExecutor(Params... params) {
